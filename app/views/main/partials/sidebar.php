    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item mb-2 <?= $data['title'] == 'Add Transaction' || $data['title'] == 'Transaction Status' || $data['title'] == 'Transaction History'? 'menu-open' : ''; ?>">
                    <a class="nav-link <?= $data['title'] == 'Add Transaction' || $data['title'] == 'Transaction Status' || $data['title'] == 'Transaction History'? 'active' : ''; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= BASEURL ?>/transaction" class="nav-link mb-1 <?= $data['title'] == 'Add Transaction' ? 'active' : ''; ?>">
                                <i class='bx bx-radio-circle-marked'></i>
                                <p>
                                    Tambah
                                </p>
                ...
                <li class="nav-item mb-2 <?= $data['title'] == 'Item Report' || $data['title'] == 'Transaction Report'? 'menu-open' : ''; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= BASEURL ?>/report/item" class="nav-link mb-1 <?= $data['title'] == 'Item Report'  ? 'active' : ''; ?>">
                                <i class='bx bx-radio-circle-marked'></i>
                                <p>Barang</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= BASEURL ?>/report/transaction" class="nav-link mb-1 <?= $data['title'] == 'Transaction Report' ? 'active' : ''; ?>">
                                <i class='bx bx-radio-circle-marked'></i>
                                <p>Transaksi</p>
                            </a>
                        </li>
